...
TITLE = 'The Silverton Folio'
BLURB = ("The Economic Geology sheet of USGS Folio 120 (Cross, Howe & "
         "Ransome, 1905) — the San Juan silver country's veins, tunnels and "
         "mills — draped over modern terrain, with the folio's areal geology "
         "one slider-stop behind and the district's named mines as data.")
ONE   = 'the-silverton-folio.html'
