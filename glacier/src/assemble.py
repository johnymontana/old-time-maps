...
TITLE = 'Glacier in Contours'
BLURB = ("The USGS-engraved sheet of Glacier National Park, surveyed "
         "1900-1912, draped over modern terrain with the park's glaciers "
         "then and now.")
ONE   = 'glacier-in-contours.html'
