...
TITLE = 'He Sapa in Folio'
BLURB = ("Darton and Paige's 1925 geologic folio of the Central Black Hills — "
         "the Harney Peak and Hermosa sheets joined — over their 1901 engraved "
         "topography and modern terrain, with Wind Cave, the granite crest and "
         "the pegmatite mines as data.")
ONE   = 'he-sapa-in-folio.html'
