...
Writes two builds:
    ...
    the-park-special.html      one self-contained file, assets inlined as
...
TITLE = 'The Park Special'
BLURB = ("The 1915 USGS topographic map of Rocky Mountain National Park — the "
         "one classic park special that survives complete and georeferenced — "
         "over the Longs Peak quadrangle of the same survey and modern terrain.")
ONE   = 'the-park-special.html'
