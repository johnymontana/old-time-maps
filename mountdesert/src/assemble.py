...
TITLE = 'Pemetic: the Island Before Acadia'
BLURB = ("The 1904 Bar Harbor and Mount Desert quadrangles joined at 68°15′, "
         "printed when the park was still called Lafayette, over the 1942 "
         "War Department resurvey and modern terrain — Pemetic, the island "
         "the Wabanaki named, with its whole archipelago as data.")
ONE   = 'pemetic-mount-desert.html'
