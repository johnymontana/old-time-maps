...
Writes two builds:
    ...
    the-smokies-in-folio.html  one self-contained file, assets inlined as
...
TITLE = 'The Smokies in Folio'
BLURB = ("Arthur Keith's 1895 Knoxville folio — the Great Valley in reds, the "
         "Great Smoky Mountains thrust over it in grey, four cove windows worn "
         "through — over the folio's own topography and the crest's named gaps.")
ONE   = 'the-smokies-in-folio.html'
