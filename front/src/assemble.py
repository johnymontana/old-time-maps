...
TITLE = 'The Rocky Mountain Front'
BLURB = ("Four quadrangles of the Rocky Mountain Front (1903-1920) tiled "
         "into one block - the overthrust wall over the plains - with "
         "Ayres' 1899 forest-reserve survey one layer behind.")
ONE   = 'rocky-mountain-front.html'
