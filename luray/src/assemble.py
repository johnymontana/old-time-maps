...
Writes two builds:
    ...
    hollows-of-stony-man.html  one self-contained file, assets inlined as
...
TITLE = 'The Hollows of Stony Man'
BLURB = ("The USGS Luray sheet of 1893 — the Blue Ridge surveyed by "
         "reconnaissance in 1884–86, forty years before Shenandoah "
         "National Park — over the 1933 Stony Man resurvey and modern terrain.")
ONE   = 'hollows-of-stony-man.html'
