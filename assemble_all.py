...
SHEETS = [  # gallery order: oldest sheet first
    ...
    dict(d='nome', g='Alaska', title='Nome, the Golden Beach', era='U.S. Geological Survey · Bulletin 533 · 1904–13',
         blurb='The only gold rush a steamer ticket could join: the Nome '
               ...
               'the tundra as data.',
         credit='U.S. Geological Survey'),
    dict(d='brightangel', g='Arizona', title='Bright Angel', era='U.S. Geological Survey · Matthes, 1903 & 1907',
         blurb='François Matthes’ plane-table specials at 1:48,000 — the '
               ...
               'same ground.',
         credit='U.S. Geological Survey'),
    dict(d='yosemite', g='California', title='Yosemite Before the Dam', era='U.S. Geological Survey · 1898–1911 & 1930',
    ...
    dict(d='silverton', g='Colorado', title='The Silverton Folio', era='U.S. Geological Survey · Cross, Howe & Ransome, 1905',
         ...
         credit='U.S. Geological Survey'),
    dict(d='estes', g='Colorado', title='The Park Special', era='U.S. Geological Survey · 1915',
         ...
         credit='U.S. Geological Survey'),
    dict(d='kilauea', g='Hawaiʻi', title='Kīlauea and Mauna Loa', era='U.S. Geological Survey · 1921–1930',
    ...
    dict(d='coeurdalene', g='Idaho', title='The Coeur d’Alene', era='U.S. Geological Survey · Ransome & Calkins, 1908',
         ...
         credit='U.S. Geological Survey'),
    dict(d='mountdesert', g='Maine', title='Pemetic: the Island Before Acadia', era='U.S. Geological Survey · 1904 & 1942',
         ...
         credit='U.S. Geological Survey'),
    dict(d='mazama', g='Oregon', title='Mazama: Crater Lake in Professional Paper 3', era='U.S. Geological Survey · Kerr & Diller · 1886–1902',
         ...
         credit='U.S. Geological Survey'),
    dict(d='blackhills', g='South Dakota', title='He Sapa in Folio', era='U.S. Geological Survey · Darton & Paige, 1925',
         ...
         credit='U.S. Geological Survey'),
    dict(d='smoky', g='Tennessee', title='The Smokies in Folio', era='U.S. Geological Survey · Keith, 1895',
         ...
         credit='U.S. Geological Survey'),
    dict(d='chisos', g='Texas', title='The Big Bend, 1903', era='U.S. Geological Survey · 1903',
         ...
         credit='U.S. Geological Survey'),
    dict(d='luray', g='Virginia', title='The Hollows of Stony Man', era='U.S. Geological Survey · 1893 & 1933',
