...
TITLE = 'Mazama: Crater Lake in Professional Paper 3'
BLURB = ("Mark B. Kerr's 1886 survey of Crater Lake National Park, printed as "
         "Plate I of USGS Professional Paper 3, over Diller's 1902 geology and "
         "modern terrain — with the Cleetwood's soundings as data.")
ONE   = 'mazama-crater-lake.html'
