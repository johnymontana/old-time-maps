...
TITLE = 'Kīlauea and Mauna Loa'
BLURB = ("Four 1921–28 quadrangles of Hawaiʻi — Mauna Loa, Kilauea, Honuapo, "
         "Pahala — draped from the Kaʻū surf to Mokuʻāweoweo at 13,665 feet, "
         "with Stearns' 1930 geology of the Kaʻū district between them and "
         "the named lava flows as data.")
ONE   = 'kilauea-and-mauna-loa.html'
