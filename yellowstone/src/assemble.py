...
TITLE = 'Yellowstone in Folio'
BLURB = ("Arnold Hague's 1896 geologic folio of Yellowstone National Park — "
         "four quadrangle sheets joined — over their 1911 engraved "
         "topography and modern terrain, with the named geysers as data.")
ONE   = 'yellowstone-in-folio.html'
