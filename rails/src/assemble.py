...
TITLE = 'Montana by Rail'
BLURB = ("Rand McNally's 1912 railroad map of Montana over Cram's 1884 "
         "territory map and the state's terrain - twenty-eight years of "
         "railroad building on one slider, passes and tunnels as data.")
ONE   = 'montana-by-rail.html'
