...
Writes two builds:
    ...
    yosemite-before-the-dam.html
                               one self-contained file, assets inlined as
...
TITLE = 'Yosemite Before the Dam'
BLURB = ("Four USGS quadrangles of 1898–1911 — printed while Hetch Hetchy "
         "was still a valley — joined over modern terrain, with Matthes' "
         "1930 park map between them and the named falls as data.")
ONE   = 'yosemite-before-the-dam.html'
