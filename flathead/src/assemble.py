...
TITLE = 'The Flathead Country'
BLURB = ("Flathead Lake and its valley on the U.S. Army's 1920 and 1943 "
         "Progressive Military Map sheets, georeferenced and draped over "
         "modern terrain.")
ONE   = 'the-flathead.html'
