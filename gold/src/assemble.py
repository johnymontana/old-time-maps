...
TITLE = 'The Gold Regions, 1865'
BLURB = ("W.W. de Lacy's 1865 map of Montana Territory and its gold "
         "diggings, georeferenced and draped over modern terrain, with "
         "every recorded gold and silver producer since.")
ONE   = 'gold-regions-1865.html'
