...
TITLE = 'The Coeur d\'Alene'
BLURB = ("Ransome & Calkins' 1908 geologic map of the Coeur d'Alene "
         "silver-lead district — over its 1906 special base and modern "
         "terrain, with the named mines as data.")
ONE   = 'coeur-dalene.html'
