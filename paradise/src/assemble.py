...
TITLE = 'The Livingston Sheet'
BLURB = ("Folio 1 of the Geologic Atlas of the United States (1894) — "
         "Paradise Valley, Tom Miner Basin, the Boulder and the Crazies — "
         "over its 1891 topography and modern terrain, mines as data.")
ONE   = 'livingston-sheet.html'
