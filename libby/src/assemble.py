...
TITLE = 'The Libby Quadrangle'
BLURB = ("Gibson's 1948 geologic map of the Libby quadrangle — the Cabinet "
         "Mountains' silver-lead district — over its 1932 base and modern "
         "terrain, with the recorded mines as data.")
ONE   = 'libby-quadrangle.html'
