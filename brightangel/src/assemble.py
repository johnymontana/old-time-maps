...
Writes two builds:
    ...
    bright-angel.html          one self-contained file, assets inlined as
...
TITLE = 'Bright Angel'
BLURB = ("Francois E. Matthes' 1903 and 1907 quadrangle specials of the Grand "
         "Canyon, joined at 112\u00b0W over the Powell survey's 1886 "
         "reconnaissance and modern terrain, with the canyon's rapids and "
         "springs as data.")
ONE   = 'bright-angel.html'
