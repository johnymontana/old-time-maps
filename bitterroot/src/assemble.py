...
BLURB = ("The Hamilton and Missoula quadrangles (1901 & 1912) joined — the "
         "Bitterroot Valley end to end — over Leiberg's 1898 forest survey "
         "and modern terrain, with the valley's mines as data.")
ONE   = 'the-bitterroot.html'
