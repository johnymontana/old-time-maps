...
TITLE = 'The Big Bend, 1903'
BLURB = ("Two 1903 Geological Survey quadrangles of the Rio Grande's great "
         "bend — Terlingua and Chisos Mountains — over modern terrain, with "
         "the 1984–85 metric sheets behind and the desert's springs as data.")
ONE   = 'the-big-bend-1903.html'
