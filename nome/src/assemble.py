...
TITLE = 'Nome, the Golden Beach'
BLURB = ("Bulletin 533's Nome quadrangle — Moffit's 1913 geology of the "
         "Cape Nome placers over Gerdine's 1904 topography and modern "
         "terrain, with the district's placer creeks as data.")
ONE   = 'nome-golden-beach.html'
