...
TITLE = 'The Head of Navigation'
BLURB = ("The Great Falls (1886) and Fort Benton (1890) degree sheets "
         "joined - the five falls, the portage, the levee at the head of "
         "navigation - with the 1890 Cascade County map one layer behind.")
ONE   = 'head-of-navigation.html'
